...
class DepartmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            if ($request->isMethod('post')) {
                ...
                $view = 'employee.department.search';
            } else {
                $department = Department::latest()->paginate(10);
                $view = 'employee.department.index';
            }
    ...
    {
        return view('employee.department.add');
    }
    ...
    public function store(Request $request)
    {
        try{
            ...
            if($department){
                return redirect('admin/department')->with('flash_message', 'Department created successfully!');
            }
        }catch(\Exception $e){
            return back()->withErrors($e);
        }
    ...
    public function edit($id)
    {
        try{
            ...
            if($department){
                ...
                return redirect('department')->with('flash_message', 'There is something wrong.');
            }
        }catch(\Exception $e){
            return redirect('department')->with('flash_message', 'There is something wrong.');
        }
    ...
    public function update(Request $request, $id)
    {
        try{
            ...
            if($dept){
                return redirect('department')->with('flash_message', 'Department has been updated successfully.');
            }else{
                return redirect('department')->with('flash_message', 'There is something wrong.');
            }
        }catch(\Exception $e){
    ...
    public function status($id){
        try{
            ...
            $dept->update();
            if($dept){
                return redirect('department')->with('flash_message', $dept->name.' status has been changed successfully.');
            }else{
                return redirect('department')->with('flash_message', 'There is something wrong. Please try again.');
            }
        }catch(\Exception $e){
            return redirect('department')->with('flash_message', 'There is something wrong. Please try again.');
        }
