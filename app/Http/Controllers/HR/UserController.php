...
class UserController extends Controller
{
    ...
    */
    public function store(Request $request){
      ...
      return redirect('/hr/users')->with('flash_message', 'User created successfully!');
    }
    ...
    */
    ...
    public function update(Request $request,$id){
        try{
            ...
            return redirect('/hr/users')->with('flash_message', 'User updated successfully!');
        }catch(\Exception $e){
            return redirect('/hr/users')->withErrors($e->getMessage());
        }
    }
    ...
    */
      ...
      return redirect('/hr/users')->with('flash_message', 'User deleted successfully!');
    }
