...
class InventoryItemController extends Controller
{
  ...
  public function __construct()
  {
    ...
    $this->prefix= 'pm/inventory/inventory_item';
    $this->asprefix= 'pm/inventory/assigned_stock';
  ...
  public function store(InventoryItemStoreRequest $request)
  {
    try
    {
      ...
      if(!empty($request->company_name))
      {
        ...
        {
          DB::commit();
          return redirect('pm/inventory_item')->with('success','Inventory Item created successfully.');
        }
        else
        {
          DB::rollback();
          return redirect('pm/inventory_item/create')->with('error','Something went wrong.');
        }
      }
    }
    catch (\Exception $e)
    {
      DB::rollback();
      $errors             = $e->getMessage();
      return redirect('pm/inventory_item/create')->with('error',$errors);
    }
  }
  ...
  public function update(Request $request, InventoryItem $inventoryItem)
  {
    try
    {
      ...
      if(!empty($request->company_name))
      {
        ...
        {
          DB::commit();
          return redirect('pm/inventory_item')->with('success','Inventory Item updated successfully.');
        }
        else
        {
          DB::rollback();
