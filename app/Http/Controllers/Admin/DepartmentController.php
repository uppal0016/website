...
class DepartmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            if ($request->isMethod('post')) {
                ...
                $view = 'admin.department.search';
            } else {
                $department = Department::latest()->paginate(10);
                $view = 'admin.department.index';
            }
    ...
    public function edit($id)
    {
        try{
            ...
            if($department){
                ...
                return redirect('/admin/department')->with('flash_message', 'There is something wrong.');
            }
        }catch(\Exception $e){
            return redirect('/admin/department')->with('flash_message', 'There is something wrong.');
        }
    ...
    public function update(Request $request, $id)
    {
        try{
            ...
            if($dept){
                return redirect('/admin/department')->with('flash_message', 'Department has been updated successfully.');
            }else{
                return redirect('/admin/department')->with('flash_message', 'There is something wrong.');
            }
        }catch(\Exception $e){
    ...
    public function status($id){
        try{
            ...
            $dept->update();
            if($dept){
                return redirect('/admin/department')->with('flash_message', $dept->name.' status has been changed successfully.');
            }else{
                return redirect('/admin/department')->with('flash_message', 'There is something wrong. Please try again.');
            }
        }catch(\Exception $e){
            return redirect('/admin/department')->with('flash_message', 'There is something wrong. Please try again.');
        }
