      ...
      <div class="row align-items-center py-4">
        ...
        <form id="searchForm" method="get" action="javascript:void(0);" role="search">
          <div class="input-group custom-searchfeild ">
            ...
            <input autocomplete="off" name="search" type="text" class="form-control search-length" placeholder="Search by department name" aria-describedby="button-addon6" id="search">
    ...
    <div class="col">
      <div class="card minHeight">
        ...
        <div class="card-header border-0 d-flex align-items-center justify-content-between">
          ...
          <div class="">        
          <a href="{{ URL('admin/department/create') }}" class="btn btn-primary add-user-btn add-topic-btn" title="Add Department">+</a><br/>
        </div>
        </div>
