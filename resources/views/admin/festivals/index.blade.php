                    ...
                    <div class="col-lg-8 col-7">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Manage Festival Cards</li>
                            </ol>
                        </nav>
                    </div>
                        ...
                        <form id="searchForm" method="get" action="javascript:void(0);" role="search">
                            <div class="input-group custom-searchfeild ">
                                <div class="col-sm-12 customSearch padd_0">
                                    ...
                                    <input type="hidden" name="action" value="/festival">
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col">
                <div class="card minHeight">
                    ...
                    <div class="card-header border-0 d-flex align-items-center justify-content-between">
                        <h3 class="mb-0">Festival Card List</h3>
                        <div class="">
                            <a href="{{ URL('admin/festival/create') }}" class="btn btn-primary add-user-btn add-topic-btn" title="Add Festival Card">+</a><br/>
                        </div>
                    </div>
