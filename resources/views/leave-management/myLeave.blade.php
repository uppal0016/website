            ...
            <div class="col-lg-4 col-7 secRight">
                    ...
                    <div class="card card-stats">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <h5 class="card-title text-uppercase text-muted mb-0">   Total  Assigned Leave - 
         ...
         <div class="card minHeight">
            ...
            <div class="card-header border-0">
               ...
               <div class="row align-items-end">
                  ...
                  <div class="col-md-2">
                     <div class="input-group custom-searchfeild">
                        <button type="button" class="btn btn-primary" onclick="myleavedaterange()">Search</button>
                     </div>
                  </div>
