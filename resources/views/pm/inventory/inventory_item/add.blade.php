        ...
        <div class="panel-body">
          <div class="canvas-wrapper">
            <div class="table-responsive">
              {!! Form::open(array('action' => 'PM\InventoryItemController@store','method'=>'POST','enctype'=>'multipart/form-data','id'=>'add_inventoryItem')) !!}
              <table class="table input-lists">
                <tbody>
                  <tr>
                    <td>
                      {!! Form::text('generate_id', null, ['class'=> 'form-control generate_id','readonly'=>'true']); !!}
                      {!! Form::hidden('last_generate_id', Helper::generate_id(), ['class'=> 'form-control last_generate_id','readonly'=>'true']); !!}
