    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading pull-right">
          <a href="{{ url('/pm/user/create') }}" class="btn btn-primary add-user-btn add-topic-btn">+ Add User </a><br/>
        </div>
                ...
                <tbody>
                  @foreach($users as $value)
                    <tr>
                      ...
                      <td>
                          <a href="{{action('PM\UserController@edit',$value['en_id'])}}" title="Edit User"><i class="fa fa-edit"></i>
                          </a> &nbsp 
                          <a href="{{ url('/pm/destroy',$value['en_id']) }}" title="Delete User"><i class="fa fa-trash-o"></i>
                          </a> &nbsp
                          @if($pro->count())
                          <a href="javascript:void(0)" class="assign" id="user_{{$value['en_id']}}" data="{{$value->project_assign->count() ? $value->project_assign[0]->project_id : ''}}" data-name="{{$value->full_name}}" title="Assigned Project">
                            <i class="fa fa-plus"></i>
                          </a> &nbsp 
                          @endif
                          <a href="javascript:void(0)" class="time_estimate" id="user_{{$value['en_id']}}"  data-name="{{$value->full_name}}" title="Get Project Time Estimate">
      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <div class="modal-body">
          <form method="post" action="{{url('pm/user/assign') }}">
            {{csrf_field()}}
            <div class="row">
              <div class="col-lg-6">
                <!-- <h1 class="header"></h1> -->
              ...
              <div class="col-lg-6">
                ...
                <div class="button-group ">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select_btn_icon" name="project_id">
