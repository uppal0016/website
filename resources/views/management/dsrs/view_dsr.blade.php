...
@include('common.sidebar.sidebar_mgm') 
...
$(document).ready(function(){
  ...
  $(document).on('click', '.dsr-point', function(){
    ...
    $.get('/management/get_dsr_details/' + getId, function(success){
      ...
      if(success !=''){
        ...
        // +( (success.files && success.files.length) ? '<a class="display_attachment" data="'+success.files[0].path_name+'" data-name="'+success.files[0].original_name+'" href="javascript:void(0)"><i class="fa fa-paperclip" aria-hidden="true"></i> '+ success.files[0].original_name +'</a>' : 'N-A' )+'</p>';
