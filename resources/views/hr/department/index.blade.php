                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="pull-right">
                                    <a href="{{ URL('hr/department/create') }}" class="btn btn-primary add-user-btn add-topic-btn">+ Add Department </a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    @foreach($department as $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ action('HR\DepartmentController@edit',$encryptId) }}" title="Edit Department">
                                                ...
                                                @endphp
                                                <a href="{{ url('/hr/department_status',$encryptId) }}" title="<?php echo $statusText; ?>">
                                                    <i class="<?php echo $icon; ?>"></i>
                                                </a> &nbsp
                                                <a href="javascript:void(0);" onclick="$(this).find('form').submit();" title="Delete Designation">
                                                    <i class="fa fa-trash-o"></i>
                                                    <form action="{{ url('/hr/department',$encryptId) }}" method="post">
                                                        {{ method_field('DELETE') }}
                                                        {{ csrf_field() }}
                                                    </form>
                                                </a>
