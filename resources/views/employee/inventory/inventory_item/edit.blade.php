        ...
        <div class="panel-body">
          <div class="canvas-wrapper">
            <div class="table-responsive">
              <form action="{{ route('emp.inventory_item.update',$inventoryItem->id) }}" method="POST" id="add_vendor" enctype="multipart/form-data">
                <table class="table input-lists">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        {!! Form::text('generate_id', $inventoryItem->generate_id, ['class'=> 'form-control','readonly'=>'true']); !!}
                    ...
                    <tr>
                      <td>
                        {!! Form::select('status', array('1' => 'Active', '0' => 'Inactive'),$inventoryItem->is_deleted,['class'=> 'form-control']) !!}
                        <span class="text-danger">
                          {{$errors->first('status')}}
                        </span>
                      </td>
