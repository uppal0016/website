<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        {!! Form::open(array('action' => 'Employee\InventoryItemController@change_item_status','method'=>'POST','id'=>'add_reason')) !!}
        {!! Form::hidden('_token', Session::token()) !!}
        {!! Form::hidden('type','change_status') !!}
        {!! Form::hidden('id',isset($inventoryItem->id)?$inventoryItem->id:null,['class'=>'item_id']) !!}
        ...
        <div class="col-md-12">
          ...
          <div class="form-group clearfix">
            {!! Form::select('avilability_status', array(''=>'Select Status','0' => 'Spare'),isset($inventoryItem->avilability_status)?$inventoryItem->avilability_status:null,['class'=> 'form-control avl_cls']) !!}
