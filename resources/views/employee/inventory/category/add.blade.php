  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="pull-right">
        <a href="{{ url('category') }}" class="btn btn-primary add-user-btn add-topic-btn">Back </a><br/>
      </div>
      ...
      <div class="panel-body">
        <div class="canvas-wrapper">
          <div class="table-responsive">
            {!! Form::open(array('action' => 'Employee\CategoryController@store','method'=>'POST','id'=>'add_category')) !!}
