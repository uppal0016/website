        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="pull-right">
              <a href="{{ $url.'/category/create' }}" class="btn btn-primary add-user-btn add-topic-btn">+ Add Category </a><br/>
            </div>
          </div>
        </div>
      </div>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $value->name }}</td>
                  <td>
                    <a href="{{ action('Employee\CategoryController@edit',Crypt::encrypt($value->id)) }}" title="Edit Category">
