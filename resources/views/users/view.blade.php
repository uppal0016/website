          ...
          <h3 class="mb-0">View Employee</h3>
            ...
            <div class="row">
              <div class="col-sm-2 profilePIC">
                  ...
                  <div class="row">
                              <div class="form-group col-sm-4">
                                  ...
                                  <div class="input-group input-group-merge input-group-alternative">
                                      <input type="text" name="employee_code" id="employee_code" value="{{$user->employee_code}}" placeholder="Enter Employee Code" class="form-control" autocomplete="off">
                                  </div>
							  ...
							  <div class="form-group col-sm-4">
                                ...
                                <div class="input-group input-group-merge input-group-alternative">
									<input type="text" name="phone_number" value="{{$user->phone_number}}" id="phone_number" placeholder="Enter Mobile number" class="form-control" autocomplete="off" disabled/>
                                </div>
                                <span class="text-danger">
							  ...
							  <div class="form-group col-sm-4">
								<label for="exampleInputEmail1">Date Of Birth</label>
									<div class="input-group input-group-merge input-group-alternative">
                  <input type="text" name="date_of_birth" id="datepickerDOB" value="{{old('date_of_birth',$user->dob)}}" placeholder="Enter Date Of Birth" class="form-control" autocomplete="off" disabled/>
									</div>
                  <span class="text-danger">
							  ...
							  <div class="form-group col-sm-4">
							  	<label for="exampleInputEmail1">Date Of Joining<i class="fa fa-asterisk" style="font-size:6px;color:red"></i></label>
									<div class="input-group input-group-merge input-group-alternative">
                  <input type="text" name="date_of_joining" id="datepickerDOJ" value="{{old('date_of_joining',$user->joining_date)}}" placeholder="Enter Date Of Joining" class="form-control" autocomplete="off" disabled/>
									</div>
                  <span class="text-danger">
                ...
                <div class="form-group col-sm-4">
									<label for="exampleInputEmail1">End of Probation</i></label>
									  <div class="input-group input-group-merge input-group-alternative">
									  <input type="text" name="date_of_exp_probation" id="datepickerDOPX" value="{{old('date_of_exp_probation',$user->end_probation)}}" placeholder="Enter Date Of Probation" class="form-control" autocomplete="off" disabled/>
									  </div>
									<span class="text-danger">
									{{$errors->first('date_of_joining')}}
								</span>
							  ...
							  <div class="form-group col-sm-4">
								...
								<div class="input-group input-group-merge input-group-alternative">
									<input type="text" name="pan_number" id="pan_number" maxlength="10" value="{{$user->pan_number}}" placeholder="Enter Pan Number" class="form-control" autocomplete="off" disabled/>
									</div>
                  <span class="text-danger">
                ...
                @php $dept = Helper::getDepartments(); @endphp
							  ...
							  <label for="exampleInputEmail1">Department<i class="fa fa-asterisk" style="font-size:6px;color:red"></i></label>
								<div class="input-group input-group-merge input-group-alternative">
									<select name="department" class="form-control select_btn_icon" disabled>
                ...
                @php $desg = Helper::getDesignations(); @endphp
							  ...
							  <label for="exampleInputEmail1">Designation<i class="fa fa-asterisk" style="font-size:6px;color:red"></i></label>
								<div class="input-group input-group-merge input-group-alternative">
									<select name="designations" class="form-control select_btn_icon" disabled>
              ...
              <div class="form-group col-sm-4">
                ...
                <div class="input-group input-group-merge input-group-alternative">
                    <select name="reportingManager[]" id="reporting_manager_one" class="form-control select_btn_icon" multiple disabled>
            ...
            @endif
							  ...
							  <label for="exampleInputEmail1">Status<i class="fa fa-asterisk" style="font-size:6px;color:red"></i></label>
								<div class="input-group input-group-merge input-group-alternative">
								<select  class="form-control select_btn_icon" name="status" id="status" disabled>
                              @php $selected = ''; @endphp
                              @if ($user->status ==  1)
                                @php $selected = 'selected'; @endphp
                              @endif
                ...
                <div class="input-group input-group-merge input-group-alternative">
                 <input type="time" name="shift_start_time" class="form-control" value="{{$user->shift_start_time}}" disabled>
                </div>
                ...
                <div class="input-group input-group-merge input-group-alternative">
                 <input type="text" name="g_meet_link" class="form-control" placeholder=" Enter Link" value="{{$user->g_meet_link}}" disabled>
                </div>
                </div>
                ...
                <div class="form-group col-sm-4">
                  ...
                  <div class="input-group input-group-merge input-group-alternative">
                      <select class="form-control select_btn_icon" name="work_mode" id="work_mode" disabled>
                          @php $selected = ''; @endphp
                ...
                <div class="form-group col-sm-12">
								...
								<div class="input-group input-group-merge input-group-alternative">
									<textarea type="text" rows="5" cols="100" name="address" id="address" placeholder="Enter Address" class="form-control" autocomplete="off" disabled>{{$user->address}}</textarea>
								</div>
                <span class="text-danger">
                      ...
                      <div class="form-group col-sm-12">
                          ...
                          <div class="input-group input-group-merge input-group-alternative">
                              <textarea type="text" rows="5" cols="100" name="permanent_address" id="permanent_address" placeholder="Enter Permanent Address" class="form-control" autocomplete="off" disabled>{{$user->permanent_address}}</textarea>
                          </div>
                          <span class="text-danger">
...
<script>
	$(document).ready(function() {       
		$('#reporting_manager_one').multiselect({		
			nonSelectedText: 'Select Assigning Reporting Manager'				
		});
	});
</script>
@endsection
