            ...
            <td align="center" valign="top" style="padding: 15px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:24px;padding: 15px 0px; font-weight:bold; color:#272727; text-align: center;">
                                                <span style="margin-left:5px"> Dsr Rejected</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello {{ $details['Name'] }} ,</b><br><br>                               
                        ...
                        <tr>
                            <td align="left" valign="top">
                              Your DSR has be rejected and the reason is  <?php echo $details['dsr_rejection_reason'];?> 
                            </td>
                        </tr>
                        &nbsp
                          &nbsp
