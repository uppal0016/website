            ...
            <td align="center" valign="top" style="padding: 15px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:24px;padding: 15px 0px; font-weight:bold; color:#272727; text-align: center;">
                                                <span style="margin-left:5px">Late Time In</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello Sir/Ma'am,</b><br></br>                              
                               
                            </td>     
                        </tr>
                       
                        <tr>
                            <td align="left" valign="top"> Due to <?php echo $details['LateReason'];?>, {{$details['name']}} did "Time In" late today and arrived at <?php echo $details['time_in'] ?>.
