                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello Sir/Ma'am,</b><br>
                                ...
                                <p style="display:inline"><span style="padding-right: 10px">Total Present: <b>{{$details['total_present']}}</b></span> <span style="padding-right: 10px">Total Absent: <b>{{$details['total_absent']}}</b></span></p>
                            </td>     
                        </tr>
