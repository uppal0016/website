                    ...
                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:24px;padding: 15px 0px; font-weight:bold; color:#272727; text-align: center;">
                                                <span style="margin-left:5px">Welcome to DSR Manager</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello {{$data['receiver']}},</b><br>
                                <p>You account have been successfully registered. Your credentials are:</p><br><br>
                                <b>Email:</b> {{$data['email']}}<br>
                                <b>Password:</b> {{$data['password']}}<br>
                                <br>
                                You can login with your credentials from <a href="{{url('login')}}">here</a>.
                                <br>
                                <br>
                                *If the above link doesn't work, paste this url in your browser.
                                <b>{{url('login')}}</b>
                            </td>
                        </tr>
                    <tr>
