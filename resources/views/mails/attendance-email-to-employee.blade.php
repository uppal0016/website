            ...
            <td align="center" valign="top" style="padding: 15px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello {{ $details['name'] }},</b>
                                <?php if($details['type'] == 'time_in') {
                                    ?>
                                    <p>You have marked attendance for today. </p>
                                <?php
                                    }else{?>
               ...
               <tr><td style="border-top:1px solid #ddd;"></td></tr>
                ...
                <tr>
                    <td style="color:#282828;font-size:13px;text-align: center;font-weight:600; ">Visit us on: <a href="https://www.talentelgia.com" style="color:#4083e7;">www.talentelgia.com</a></td>
                </tr>
