                    ...
                    <tbody>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello Sir/Ma'am,</b><br>
                                <p>Please find below the today's absent employees details:</p>
                                <p style="display:inline"><span style="padding-right: 10px">Total Presented: <b>{{$details['total_present']}}</b></span> <span style="padding-right: 10px">Total Absented: <b>{{$details['total_absent']}}</b></span></p>
                            </td>     
                        </tr>
                    
                        <tr>
                            <td align="left" valign="top">
                                <table width="100%" style="margin-top:15px; border: solid 1px #d7d9da;background-color: #f0f3f3" border="0" cellspacing="0" cellpadding="0">
                                    <thead>
                                    <tr>
                                        <th align="left" valign="top" style="border-bottom: solid 1px #d7d9da; padding: 10px 12px">Employee Name</th>
                                        <th align="left" valign="top" style="border-bottom: solid 1px #d7d9da; padding: 10px 12px">Employee Code</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($details['absent'] as $employee)
                                    <tr>
                                        <td align="left" valign="top" style="border-bottom: solid 1px #d7d9da; padding: 10px 12px">
                                            {{ $employee['Name'] }}</td>
                                        <td align="left" valign="top" style="border-bottom: solid 1px #d7d9da; padding: 10px 12px">{{ $employee['Employee Code'] }}</td>
                                    </tr>
                                    @endforeach
                        ...
                        <tr>
                            <td align="left" valign="top" style="margin-top: 20px"><b>Download File</b><br>
                                <a href="{{$details['downloadLink']}}" download>click here to Download</a>
                            </td>
                        </tr>
                    <tr>
