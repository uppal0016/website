...
<?php  $link = env('APP_URL').'/password/reset/'.$token ?>
                    <tr>
...
into your web browser: <a target="_blank" href="{{$link}}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;" rel="noopener">{{$link}}</a></p>
        </td>
    </tr>
</tbody></table>
