...
<?php  $link = env('APP_URL').'/it-tickets/details/'?>
            ...
            <td align="center" valign="top" style="padding: 15px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:24px;padding: 15px 0px; font-weight:bold; color:#272727; text-align: center;">
                                                <span style="margin-left:5px">Tickets</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello</b>
                              <br>
                              <b>{{$userName}}</b> has updated the status of your ticket to <b>{{$ticketStatus}}</b>.
                              <br><br>
                           
                           <div style="float:left;width:100%;text-align: left;margin-top: 20px;padding:5px">
                                      Kindly click on  link "<a href="{{$link}}{{$ticketNumber}}" target="_blank"> Click Here</a> " to reply to ticket.
                                      </div>
               ...
               <tr><td style="border-top:1px solid #ddd;"></td></tr>
                ...
                <tr>
                    <td style="color:#aaa;text-align: center;font-size:12px;font-weight:normal; ">Copyright © 2023 Talentelgia. All Rights Reserved.</td>
                </tr>
