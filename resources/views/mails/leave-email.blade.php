            ...
            <td align="center" valign="top" style="padding: 15px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:24px;padding: 15px 0px; font-weight:bold; color:#272727; text-align: center;">
                                                <span style="margin-left:5px">Welcome to TalentOne</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello {{$details['receiver']->first_name}},</b>
                              @if($details['type'] == 'employee')
                              <p>You have applied leave. </p>
                              @else
                              
                              <p>You have got Leave request of <strong>{{ $details['name'] }} ({{ $details['emp_code'] }})</strong></p>
                              @endif
                              
                              <br>
                              <br>
                              <div style="float:left;width:100%;text-decoration: underline;font-size: 14px;margin-bottom: 10px;margin-top: 5px">
                                <b>Title: {{$details['leave']->title}}</b><br>
                                <b>Description: {{@$details['leave']->description }}</b><br>
                                <b>Type: {{@$details['leave']->type }}</b><br>
                                <b>Start Date: {{@$details['leave']->start_date }}</b><br>
                                <b>End Date: {{@$details['leave']->end_date }}</b><br>
                              </div>
                            </td>
                        </tr>
                    <tr>
