            ...
            <td align="center" valign="top" style="padding: 15px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:24px;padding: 15px 0px; font-weight:bold; color:#272727; text-align: center;">
                                                <span style="margin-left:5px">Weekly Report</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello {{$receiver['first_name']}},</b><br>
                              {{$sender['first_name']}} {{$sender['last_name']}} has just sent you a Weekly report on TalentOne <br><br>
                              <?php $tte = 0; ?>
                              ...
                              <div style="float:left;width:100%;text-decoration: underline;font-size: 14px;margin-bottom: 10px;margin-top: 5px">
                                <b>Project: {{$report_detail['project'] ? $report_detail['project']['name'] : 'Other'}}</b>
                              </div>

                              <?php $i = 1;?>
                              
                              @foreach($report_detail['details'] as $detail)
