                    ...
                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:24px;padding: 15px 0px; font-weight:bold; color:#272727; text-align: center;">
                                                <span style="margin-left:5px">Time In From Mobile ( {{date('d-m-Y')}} )</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello Sir/Ma'am,</b><br>
                                <p>Please find below the employees details whose today Time In from Mobile:</p>
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" >
                                <tbody>
                                    <tr class="bg-lighter">
                                        ...
                                        <th class="table">Employee Code</th>
                                        <th class="table">Bio Metric Time In</th>
                                        <th class="table">System/Mobile Time In</th>
                                    </tr>
                                    @if(isset($details))
                                    
                                    @for($i=0; $i<count($details); $i++)
                                    <tr>
                                        <td class="table">{{$details[$i]['name']}}</td>
                                        <td class="table">{{$details[$i]['emp_code']}}</td>
                                        <td class="table">{{$details[$i]['bio_time_in']}}</td>
                                        <td class="table">{{$details[$i]['time_in']}}</td>
                                    </tr>
                                    @endfor
                                    @endif
                                </tbody>
