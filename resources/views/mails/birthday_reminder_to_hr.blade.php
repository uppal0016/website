            ...
            <td align="center" valign="top" style="padding: 15px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-size:24px;padding: 15px 0px; font-weight:bold; color:#272727; text-align: center;">
                                                <span style="margin-left:5px">Birthday Reminder</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td align="left" valign="top"><b>Hello {{ $details['hr_name'] }},</b><br>
                                <p>Tomorrow is {{ $details['employee_name'] }}'s birthday. Don't forget to wish him/her.</p>
                            </td>
                        </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="left" valign="top">
                            <img src = "{{ url('/images/birthday_cards/'.$details['card']) }}" style="width: 100%;"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" valign="top">&nbsp;</td>
